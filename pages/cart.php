...
// Capture inline stock error, then clear from session
...
$total = 0;
$res = $conn->query("
    SELECT c.id as cart_id, c.quantity, b.id as book_id, b.title, b.author, b.price, b.category, b.stock, b.cover_image
            ...
            <div class="cart-panel-header">
                ...
                <form method="POST" action="">
                    ...
                    <button type="submit" class="cart-btn-clear"
                        onclick="return confirm('Remove all items from cart?')">Clear cart</button>
                </form>
            </div>
            ...
            <div class="cart-item <?= $hasStockError ? 'has-stock-error' : '' ?>">
                ...
                <div class="cart-item-thumb">
                    ...
                    <?php else: ?>
                        ...
                        <svg width="28" height="28" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"><path d="M12 19l7-7 3 3-7 7-3-3z"/><path d="M18 13l-1.5-7.5L2 2l3.5 14.5L13 18l5-5z"/><path d="M2 2l7.586 7.586"/><circle cx="11" cy="11" r="2"/></svg>
                        <?php else: ?>
                ...
                <!-- Qty controls + inline stock error -->
                <div class="qty-cell">
                    <div class="qty-controls">
                        ...
                        <!-- Plus button — ALWAYS submits (even at stock limit) so we get the error -->
