...
// Check if edit mode requested via GET
if (isset($_GET['edit']) && $_GET['edit'] === '1') {
    $editing = true;
}

$user       = $conn->query("SELECT * FROM users WHERE id=$uid")->fetch_assoc();
// Only count orders that have been placed (exclude cancelled)
        ...
        <div class="profile-sidebar">
            ...
            <div class="sidebar-stats">
                ...
                <div class="stat-row">
                    ...
                    <span class="stat-value"><?= htmlspecialchars($user['student_id']) ?></span>
                </div>
                <?php endif; ?>
            </div>
            ...
            <div class="sidebar-links">
                ...
                <a href="cart.php" class="sidebar-link">
                    <svg width="15" height="15" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round"><circle cx="9" cy="21" r="1"/><circle cx="20" cy="21" r="1"/><path d="M1 1h4l2.68 13.39a2 2 0 0 0 2 1.61h9.72a2 2 0 0 0 2-1.61L23 6H6"/></svg>
                    Shopping Cart
                </a>
            ...
            <div class="panel">
                <div class="panel-header">
                    ...
                    <div>
                        ...
                        <div class="panel-subtitle"><?= $editing ? 'Edit your details below' : 'Your name, contact details, and address' ?></div>
                    </div>
                    <?php if(!$editing): ?>
                ...
                <div class="panel-body">
                    ...
                    <form method="POST" action="">
                        ...
                        <div class="form-row">
                            ...
                            <div class="form-group">
                                ...
                                <input type="tel" name="phone" value="<?= htmlspecialchars($user['phone'] ?? '') ?>" placeholder="(337) 555-0000">
                            </div>
                        </div>
                        <div class="form-group">
                            <label>Shipping address</label>
                            <textarea name="address" rows="3" placeholder="Your shipping address" style="resize: vertical;"><?= htmlspecialchars($user['address'] ?? '') ?></textarea>
                        </div>
                    ...
                    <div class="form-row">
                        ...
                        <div class="form-group">
                            <label>Phone number</label>
                            <input type="tel" value="<?= htmlspecialchars($user['phone'] ?? 'Not set') ?>" disabled>
                        </div>
                    </div>
                    <div class="form-group">
                        <label>Shipping address</label>
                        <input type="text" value="<?= htmlspecialchars($user['address'] ?? 'Not set') ?>" disabled>
                    </div>
                    <?php endif; ?>
                </div>
            </div>
