...
<footer class="site-footer">
    <div class="footer-inner">
        <div class="footer-brand">
            ...
            <p class="footer-desc">Your one-stop shop for textbooks, academic materials, and supplies at McNeese State University.</p>
    ...
    <div class="footer-bottom">
        ...
        <p class="footer-team">Kushal Poudel &middot; Alok Poudel &middot; Rojal Shrestha &middot; Kelsang Yonjan</p>
    </div>
</footer>
